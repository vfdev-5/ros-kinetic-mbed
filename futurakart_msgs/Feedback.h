#ifndef _ROS_futurakart_msgs_Feedback_h
#define _ROS_futurakart_msgs_Feedback_h
...
#include "futurakart_msgs/DriveFeedback.h"
...
namespace futurakart_msgs
{
  ...
  class Feedback : public ros::Msg
  {
    public:
      ...
      futurakart_msgs::DriveFeedback drivers[2];
    ...
    const char * getType(){ return "futurakart_msgs/Feedback"; };
